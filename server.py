...
def emotion_detector_fn():
    ...
    *rest, (last_key, last_value) = response_1.items()
    ...
    output_text = output_text + joined_rest + " and '"
    output_text = output_text + str(last_key) + "': " + str(response.get(last_key))

    output_text = output_text + ".\n The dominant emotion is "
    output_text = output_text + str(response.get('dominant_emotion')) + "."
